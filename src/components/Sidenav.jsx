        ...
        <div>
            ...
            {nav ? (
                ...
                <div className='md:block hidden fixed top-[25%] z-10  '>
                    <div className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4'>
                    <a href="#main" className='  cursor-pointer hover:scale-110 ease-in duration-300'>
                        <AiOutlineHome size={20} />
                    </a>
                    </div>
                    <div className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4'>
                    <a href="#work" className='  cursor-pointer hover:scale-110 ease-in duration-300'>
                        <GrProjects size={20} />
                    </a>
                    </div>
                    <div className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4'>
                    <a href="#project" className='  cursor-pointer hover:scale-110 ease-in duration-300'>
                        <AiOutlineProject size={20} />
                    </a>
                    </div>
                    {/* <div className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4'>
                    <a href="#resume" className='  cursor-pointer hover:scale-110 ease-in duration-300'>
                        <BsPerson size={20} />
                    </a>
                    </div> */}
                    <div className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4'>
                    <a href="#contact" className='  cursor-pointer hover:scale-110 ease-in duration-300'>
                        <AiOutlineMail size={20} />
                    </a>
                    </div>
                </div>
